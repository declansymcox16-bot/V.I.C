...
app = Flask(__name__)
app.secret_key = "vic-v0.4.7-local-dashboard"
...
def transfer_worker_ready(
    ...
    if version_tuple(current) < MIN_TRANSFER_WORKER_VERSION:
        ...
        return False, (
            ...
            "START_WORKER.bat from the v0.4.7 folder."
        )
    return True, ""
...
def retry_transfer(transfer_id: str):
    ...
    update_transfer(
        ...
        state="queued_upload",
        message=(
            "Retry queued. Waiting for the v0.4.7 source worker "
