...
WINDOWS v0.4.7 — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SHARED SPEAKER LOOPBACK — v0.4.7
--------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.4.7
------------------------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.4.7
------------------------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.4.7 folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.4.7
--------------------------------
...
MASS RECORDING TRANSFERS — v0.4.7
---------------------------------
...
unless the source and destination computers are both running VIC v0.4.7. This
...
v0.4.7 Dashboard. Updating all PCs to v0.4.7 is still recommended.
...
Before v0.4.7, screen and camera recording used libx264 on the CPU. v0.4.7
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.4.7
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.4.7.


GPU DETECTION FIX — v0.4.7
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.4.7 fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.
