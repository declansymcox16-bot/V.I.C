...
WINDOWS v0.4.9 — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SHARED SPEAKER LOOPBACK — v0.4.9
--------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.4.9
------------------------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.4.9
------------------------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.4.9 folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.4.9
--------------------------------
...
MASS RECORDING TRANSFERS — v0.4.9
---------------------------------
...
unless the source and destination computers are both running VIC v0.4.9. This
...
v0.4.9 Dashboard. Updating all PCs to v0.4.9 is still recommended.
...
Before v0.4.9, screen and camera recording used libx264 on the CPU. v0.4.9
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.4.9
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.4.9.


GPU DETECTION FIX — v0.4.9
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.4.9 fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.4.9
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.4.9
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.4.9
------------------------------------
