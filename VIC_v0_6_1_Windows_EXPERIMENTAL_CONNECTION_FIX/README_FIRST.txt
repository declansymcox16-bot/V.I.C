...
WINDOWS v0.6.1 EXPERIMENTAL CONNECTION FIX — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.6.1 EXPERIMENTAL CONNECTION FIX
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.6.1 EXPERIMENTAL CONNECTION FIX
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.6.1 EXPERIMENTAL CONNECTION FIX
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.6.1 EXPERIMENTAL CONNECTION FIX
------------------------------------
...
FASTER AUDIO METERS — v0.6.1 EXPERIMENTAL CONNECTION FIX
----------------------------
...
LIVE ALL CONTROL ROOM — v0.6.1 EXPERIMENTAL CONNECTION FIX
------------------------------
...
CLEAR / DELETE CONTROLS — v0.6.1 EXPERIMENTAL CONNECTION FIX
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.6.1 EXPERIMENTAL CONNECTION FIX
--------------------------------
...
EDIT SOURCES — v0.6.1 EXPERIMENTAL CONNECTION FIX
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.6.1 EXPERIMENTAL CONNECTION FIX
------------------------------------------
...
EDIT PAGE REPAIR — v0.6.1 EXPERIMENTAL CONNECTION FIX
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.6.1 EXPERIMENTAL CONNECTION FIX folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.6.1 EXPERIMENTAL CONNECTION FIX
--------------------------------
...
MASS RECORDING TRANSFERS — v0.6.1 EXPERIMENTAL CONNECTION FIX
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.6.1 EXPERIMENTAL CONNECTION FIX
------------------------------
...
unless the source and destination computers are both running VIC v0.6.1 EXPERIMENTAL CONNECTION FIX. This
...
TRACEBACK FIXES — v0.6.1 EXPERIMENTAL CONNECTION FIX
------------------------
...
v0.6.1 EXPERIMENTAL CONNECTION FIX Dashboard. Updating all PCs to v0.6.1 EXPERIMENTAL CONNECTION FIX is still recommended.


PREVIEW MODE — v0.6.1 EXPERIMENTAL CONNECTION FIX
---------------------
...
Before v0.6.1 EXPERIMENTAL CONNECTION FIX, screen and camera recording used libx264 on the CPU. v0.6.1 EXPERIMENTAL CONNECTION FIX
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.6.1 EXPERIMENTAL CONNECTION FIX
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.6.1 EXPERIMENTAL CONNECTION FIX.


GPU DETECTION FIX — v0.6.1 EXPERIMENTAL CONNECTION FIX
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.6.1 EXPERIMENTAL CONNECTION FIX fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.6.1 EXPERIMENTAL CONNECTION FIX
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.6.1 EXPERIMENTAL CONNECTION FIX
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.6.1 EXPERIMENTAL CONNECTION FIX
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.6.1 EXPERIMENTAL CONNECTION FIX
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.6.1 EXPERIMENTAL CONNECTION FIX
------------------------------------------
