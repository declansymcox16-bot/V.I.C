...
app = Flask(__name__)
app.secret_key = "vic-v0.6.1 EXPERIMENTAL CONNECTION FIX-local-dashboard"
...
def transfer_worker_ready(
    ...
    if version_tuple(current) < MIN_TRANSFER_WORKER_VERSION:
        ...
        return False, (
            ...
            "START_WORKER.bat from the v0.6.1 EXPERIMENTAL CONNECTION FIX folder."
        )
    return True, ""
...
if __name__ == "__main__":
    ...
    print("VIC dashboard v0.6.1 EXPERIMENTAL CONNECTION FIX")
