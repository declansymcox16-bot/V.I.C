...
app = Flask(__name__)
app.secret_key = "vic-v0.4.6-local-dashboard"

DASHBOARD_VERSION = "0.4.6"
...
def transfer_worker_ready(
    ...
    if version_tuple(current) < MIN_TRANSFER_WORKER_VERSION:
        ...
        return False, (
            ...
            "START_WORKER.bat from the v0.4.6 folder."
        )
    return True, ""
...
def retry_transfer(transfer_id: str):
    ...
    update_transfer(
        ...
        state="queued_upload",
        message=(
            "Retry queued. Waiting for the v0.4.6 source worker "
