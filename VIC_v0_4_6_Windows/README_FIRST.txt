...
WINDOWS v0.4.6 — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SHARED SPEAKER LOOPBACK — v0.4.6
--------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.4.6
------------------------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.4.6
------------------------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.4.6 folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.4.6
--------------------------------
...
MASS RECORDING TRANSFERS — v0.4.6
---------------------------------
...
unless the source and destination computers are both running VIC v0.4.6. This
...
v0.4.6 Dashboard. Updating all PCs to v0.4.6 is still recommended.
...
Before v0.4.6, screen and camera recording used libx264 on the CPU. v0.4.6
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.4.6
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.4.6.
