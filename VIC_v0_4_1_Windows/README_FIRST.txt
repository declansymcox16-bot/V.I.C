...
WINDOWS v0.4.1 — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SHARED SPEAKER LOOPBACK — v0.4.1
--------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.4.1
------------------------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.4.1
------------------------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.4.1 folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.4.1
--------------------------------
