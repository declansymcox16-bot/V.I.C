...
WINDOWS v0.5.1 — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SHARED SPEAKER LOOPBACK — v0.5.1
--------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.5.1
------------------------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.5.1
------------------------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.5.1 folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.5.1
--------------------------------
...
MASS RECORDING TRANSFERS — v0.5.1
---------------------------------
...
unless the source and destination computers are both running VIC v0.5.1. This
...
v0.5.1 Dashboard. Updating all PCs to v0.5.1 is still recommended.
...
Before v0.5.1, screen and camera recording used libx264 on the CPU. v0.5.1
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.5.1
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.5.1.


GPU DETECTION FIX — v0.5.1
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.5.1 fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.5.1
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.5.1
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.5.1
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.5.1
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.5.1
------------------------------------------
