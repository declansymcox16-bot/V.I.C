...
WINDOWS v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
------------------------------------
...
FASTER AUDIO METERS — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
----------------------------
...
LIVE ALL CONTROL ROOM — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
------------------------------
...
CLEAR / DELETE CONTROLS — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
--------------------------------
...
EDIT SOURCES — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
------------------------------------------
...
EDIT PAGE REPAIR — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
--------------------------------
...
MASS RECORDING TRANSFERS — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
------------------------------
...
unless the source and destination computers are both running VIC v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM. This
...
TRACEBACK FIXES — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
------------------------
...
v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM Dashboard. Updating all PCs to v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM is still recommended.


PREVIEW MODE — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
---------------------
...
Before v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM, screen and camera recording used libx264 on the CPU. v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM.


GPU DETECTION FIX — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.6.6 EXPERIMENTAL FULLSCREEN + ZOOM
------------------------------------------
