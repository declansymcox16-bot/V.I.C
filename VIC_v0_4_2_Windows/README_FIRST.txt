...
WINDOWS v0.4.2 — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SHARED SPEAKER LOOPBACK — v0.4.2
--------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.4.2
------------------------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.4.2
------------------------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.4.2 folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.4.2
--------------------------------
...
MASS RECORDING TRANSFERS — v0.4.2
---------------------------------
