...
WINDOWS v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
------------------------------------
...
FASTER AUDIO METERS — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
----------------------------
...
LIVE ALL CONTROL ROOM — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
------------------------------
...
CLEAR / DELETE CONTROLS — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
--------------------------------
...
EDIT SOURCES — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
------------------------------------------
...
EDIT PAGE REPAIR — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
--------------------------------
...
MASS RECORDING TRANSFERS — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
------------------------------
...
unless the source and destination computers are both running VIC v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER. This
...
TRACEBACK FIXES — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
------------------------
...
v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER Dashboard. Updating all PCs to v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER is still recommended.


PREVIEW MODE — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
---------------------
...
Before v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER, screen and camera recording used libx264 on the CPU. v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER.


GPU DETECTION FIX — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER
------------------------------------------
