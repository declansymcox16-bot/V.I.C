...
app = Flask(__name__)
app.secret_key = "vic-v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER-local-dashboard"
...
def transfer_worker_ready(
    ...
    if version_tuple(current) < MIN_TRANSFER_WORKER_VERSION:
        ...
        return False, (
            ...
            "START_WORKER.bat from the v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER folder."
        )
    return True, ""
...
if __name__ == "__main__":
    ...
    print("VIC dashboard v0.8.0 EXPERIMENTAL CAPTURE + STORAGE MANAGER")
