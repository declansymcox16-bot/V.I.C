...
app = Flask(__name__)
app.secret_key = "vic-v0.3.4-local-dashboard"
...
<header><h1>VIC — Video Ingest Cluster v0.3.4</h1><nav><a href='/'>Dashboard</a><a href='/add'>+ Add source</a><a href='/mass-capture'>Capture Everything</a><a href='/workers'>Workers</a><a href='/live'>Live</a><a href='/recordings'>Recordings</a><a href='/jobs'>Jobs</a><a href='/help'>Help</a></nav></header><main>
