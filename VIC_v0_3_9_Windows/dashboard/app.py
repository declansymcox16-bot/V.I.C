...
app = Flask(__name__)
app.secret_key = "vic-v0.3.9-local-dashboard"
...
<header><h1>VIC — Video Ingest Cluster v0.3.9</h1><nav><a href='/'>Dashboard</a><a href='/add'>+ Add source</a><a href='/mass-capture'>Capture Everything</a><a href='/workers'>Workers</a><a href='/live'>Live</a><a href='/live/all'>Live All</a><a href='/recordings'>Recordings</a><a href='/jobs'>Jobs</a><a href='/help'>Help</a></nav></header><main>
...
<input name='browser_profile' placeholder='Example: Default or Profile 1'>
<p class='muted small'>The account must already be logged in on the worker that records this source. For a remote worker, VIC uses that remote PC's browser—not the Dashboard PC's browser.</p>
</div>
...
def source_form_script(
    ...
    existing_json = json.dumps(existing_source or {})
    return f"""<script>
const existingSource={existing_json};
