...
WINDOWS v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
------------------------------------
...
FASTER AUDIO METERS — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
----------------------------
...
LIVE ALL CONTROL ROOM — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
------------------------------
...
CLEAR / DELETE CONTROLS — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
--------------------------------
...
EDIT SOURCES — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
------------------------------------------
...
EDIT PAGE REPAIR — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
--------------------------------
...
MASS RECORDING TRANSFERS — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
------------------------------
...
unless the source and destination computers are both running VIC v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL. This
...
TRACEBACK FIXES — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
------------------------
...
v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL Dashboard. Updating all PCs to v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL is still recommended.


PREVIEW MODE — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
---------------------
...
Before v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL, screen and camera recording used libx264 on the CPU. v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL.


GPU DETECTION FIX — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.6.9 EXPERIMENTAL BULK SOURCE CONTROL
------------------------------------------
