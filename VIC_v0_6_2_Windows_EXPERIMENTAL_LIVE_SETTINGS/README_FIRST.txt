...
WINDOWS v0.6.2 EXPERIMENTAL LIVE SETTINGS — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.6.2 EXPERIMENTAL LIVE SETTINGS
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.6.2 EXPERIMENTAL LIVE SETTINGS
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.6.2 EXPERIMENTAL LIVE SETTINGS
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.6.2 EXPERIMENTAL LIVE SETTINGS
------------------------------------
...
FASTER AUDIO METERS — v0.6.2 EXPERIMENTAL LIVE SETTINGS
----------------------------
...
LIVE ALL CONTROL ROOM — v0.6.2 EXPERIMENTAL LIVE SETTINGS
------------------------------
...
CLEAR / DELETE CONTROLS — v0.6.2 EXPERIMENTAL LIVE SETTINGS
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.6.2 EXPERIMENTAL LIVE SETTINGS
--------------------------------
...
EDIT SOURCES — v0.6.2 EXPERIMENTAL LIVE SETTINGS
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.6.2 EXPERIMENTAL LIVE SETTINGS
------------------------------------------
...
EDIT PAGE REPAIR — v0.6.2 EXPERIMENTAL LIVE SETTINGS
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.6.2 EXPERIMENTAL LIVE SETTINGS folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.6.2 EXPERIMENTAL LIVE SETTINGS
--------------------------------
...
MASS RECORDING TRANSFERS — v0.6.2 EXPERIMENTAL LIVE SETTINGS
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.6.2 EXPERIMENTAL LIVE SETTINGS
------------------------------
...
unless the source and destination computers are both running VIC v0.6.2 EXPERIMENTAL LIVE SETTINGS. This
...
TRACEBACK FIXES — v0.6.2 EXPERIMENTAL LIVE SETTINGS
------------------------
...
v0.6.2 EXPERIMENTAL LIVE SETTINGS Dashboard. Updating all PCs to v0.6.2 EXPERIMENTAL LIVE SETTINGS is still recommended.


PREVIEW MODE — v0.6.2 EXPERIMENTAL LIVE SETTINGS
---------------------
...
Before v0.6.2 EXPERIMENTAL LIVE SETTINGS, screen and camera recording used libx264 on the CPU. v0.6.2 EXPERIMENTAL LIVE SETTINGS
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.6.2 EXPERIMENTAL LIVE SETTINGS
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.6.2 EXPERIMENTAL LIVE SETTINGS.


GPU DETECTION FIX — v0.6.2 EXPERIMENTAL LIVE SETTINGS
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.6.2 EXPERIMENTAL LIVE SETTINGS fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.6.2 EXPERIMENTAL LIVE SETTINGS
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.6.2 EXPERIMENTAL LIVE SETTINGS
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.6.2 EXPERIMENTAL LIVE SETTINGS
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.6.2 EXPERIMENTAL LIVE SETTINGS
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.6.2 EXPERIMENTAL LIVE SETTINGS
------------------------------------------
