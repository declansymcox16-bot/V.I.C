...
app = Flask(__name__)
app.secret_key = "vic-v0.6.2 EXPERIMENTAL LIVE SETTINGS-local-dashboard"

DASHBOARD_VERSION = "0.6.2"
...
def transfer_worker_ready(
    ...
    if version_tuple(current) < MIN_TRANSFER_WORKER_VERSION:
        ...
        return False, (
            ...
            "START_WORKER.bat from the v0.6.2 EXPERIMENTAL LIVE SETTINGS folder."
        )
    return True, ""
...
const setupAudioSeconds={{{{audio_refresh_seconds|tojson}}}};
const setupAudioRefreshMs=setupAudioSeconds<=0?50:Math.max(50,Math.round(setupAudioSeconds*1000));
const setupAudioSmoothing={{{{audio_smoothing|tojson}}}};
...
if __name__ == "__main__":
    ...
    print("VIC dashboard v0.6.2 EXPERIMENTAL LIVE SETTINGS")
