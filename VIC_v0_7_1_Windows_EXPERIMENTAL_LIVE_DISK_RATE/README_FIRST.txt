...
WINDOWS v0.7.1 EXPERIMENTAL LIVE DISK RATE — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.7.1 EXPERIMENTAL LIVE DISK RATE
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.7.1 EXPERIMENTAL LIVE DISK RATE
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.7.1 EXPERIMENTAL LIVE DISK RATE
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.7.1 EXPERIMENTAL LIVE DISK RATE
------------------------------------
...
FASTER AUDIO METERS — v0.7.1 EXPERIMENTAL LIVE DISK RATE
----------------------------
...
LIVE ALL CONTROL ROOM — v0.7.1 EXPERIMENTAL LIVE DISK RATE
------------------------------
...
CLEAR / DELETE CONTROLS — v0.7.1 EXPERIMENTAL LIVE DISK RATE
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.7.1 EXPERIMENTAL LIVE DISK RATE
--------------------------------
...
EDIT SOURCES — v0.7.1 EXPERIMENTAL LIVE DISK RATE
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.7.1 EXPERIMENTAL LIVE DISK RATE
------------------------------------------
...
EDIT PAGE REPAIR — v0.7.1 EXPERIMENTAL LIVE DISK RATE
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.7.1 EXPERIMENTAL LIVE DISK RATE folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.7.1 EXPERIMENTAL LIVE DISK RATE
--------------------------------
...
MASS RECORDING TRANSFERS — v0.7.1 EXPERIMENTAL LIVE DISK RATE
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.7.1 EXPERIMENTAL LIVE DISK RATE
------------------------------
...
unless the source and destination computers are both running VIC v0.7.1 EXPERIMENTAL LIVE DISK RATE. This
...
TRACEBACK FIXES — v0.7.1 EXPERIMENTAL LIVE DISK RATE
------------------------
...
v0.7.1 EXPERIMENTAL LIVE DISK RATE Dashboard. Updating all PCs to v0.7.1 EXPERIMENTAL LIVE DISK RATE is still recommended.


PREVIEW MODE — v0.7.1 EXPERIMENTAL LIVE DISK RATE
---------------------
...
Before v0.7.1 EXPERIMENTAL LIVE DISK RATE, screen and camera recording used libx264 on the CPU. v0.7.1 EXPERIMENTAL LIVE DISK RATE
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.7.1 EXPERIMENTAL LIVE DISK RATE
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.7.1 EXPERIMENTAL LIVE DISK RATE.


GPU DETECTION FIX — v0.7.1 EXPERIMENTAL LIVE DISK RATE
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.7.1 EXPERIMENTAL LIVE DISK RATE fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.7.1 EXPERIMENTAL LIVE DISK RATE
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.7.1 EXPERIMENTAL LIVE DISK RATE
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.7.1 EXPERIMENTAL LIVE DISK RATE
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.7.1 EXPERIMENTAL LIVE DISK RATE
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.7.1 EXPERIMENTAL LIVE DISK RATE
------------------------------------------
