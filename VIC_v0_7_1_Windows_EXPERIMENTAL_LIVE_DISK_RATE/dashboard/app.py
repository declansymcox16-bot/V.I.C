...
app = Flask(__name__)
app.secret_key = "vic-v0.7.1 EXPERIMENTAL LIVE DISK RATE-local-dashboard"
...
def transfer_worker_ready(
    ...
    if version_tuple(current) < MIN_TRANSFER_WORKER_VERSION:
        ...
        return False, (
            ...
            "START_WORKER.bat from the v0.7.1 EXPERIMENTAL LIVE DISK RATE folder."
        )
    return True, ""
...
if __name__ == "__main__":
    ...
    print("VIC dashboard v0.7.1 EXPERIMENTAL LIVE DISK RATE")
