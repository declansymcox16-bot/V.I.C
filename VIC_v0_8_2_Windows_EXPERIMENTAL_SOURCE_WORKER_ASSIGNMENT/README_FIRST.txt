...
WINDOWS v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
------------------------------------
...
FASTER AUDIO METERS — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
----------------------------
...
LIVE ALL CONTROL ROOM — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
------------------------------
...
CLEAR / DELETE CONTROLS — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
--------------------------------
...
EDIT SOURCES — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
------------------------------------------
...
EDIT PAGE REPAIR — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
--------------------------------
...
MASS RECORDING TRANSFERS — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
------------------------------
...
unless the source and destination computers are both running VIC v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT. This
...
TRACEBACK FIXES — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
------------------------
...
v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT Dashboard. Updating all PCs to v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT is still recommended.


PREVIEW MODE — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
---------------------
...
Before v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT, screen and camera recording used libx264 on the CPU. v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT.


GPU DETECTION FIX — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.8.2 EXPERIMENTAL SOURCE WORKER ASSIGNMENT
------------------------------------------
