...
WINDOWS v0.6.3 EXPERIMENTAL SOURCE FORM FIX — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
------------------------------------
...
FASTER AUDIO METERS — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
----------------------------
...
LIVE ALL CONTROL ROOM — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
------------------------------
...
CLEAR / DELETE CONTROLS — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
--------------------------------
...
EDIT SOURCES — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
------------------------------------------
...
EDIT PAGE REPAIR — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.6.3 EXPERIMENTAL SOURCE FORM FIX folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
--------------------------------
...
MASS RECORDING TRANSFERS — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
------------------------------
...
unless the source and destination computers are both running VIC v0.6.3 EXPERIMENTAL SOURCE FORM FIX. This
...
TRACEBACK FIXES — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
------------------------
...
v0.6.3 EXPERIMENTAL SOURCE FORM FIX Dashboard. Updating all PCs to v0.6.3 EXPERIMENTAL SOURCE FORM FIX is still recommended.


PREVIEW MODE — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
---------------------
...
Before v0.6.3 EXPERIMENTAL SOURCE FORM FIX, screen and camera recording used libx264 on the CPU. v0.6.3 EXPERIMENTAL SOURCE FORM FIX
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.6.3 EXPERIMENTAL SOURCE FORM FIX.


GPU DETECTION FIX — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.6.3 EXPERIMENTAL SOURCE FORM FIX fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.6.3 EXPERIMENTAL SOURCE FORM FIX
------------------------------------------
