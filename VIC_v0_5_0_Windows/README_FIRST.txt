...
WINDOWS v0.5.0 — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SHARED SPEAKER LOOPBACK — v0.5.0
--------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.5.0
------------------------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.5.0
------------------------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.5.0 folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.5.0
--------------------------------
...
MASS RECORDING TRANSFERS — v0.5.0
---------------------------------
...
unless the source and destination computers are both running VIC v0.5.0. This
...
v0.5.0 Dashboard. Updating all PCs to v0.5.0 is still recommended.
...
Before v0.5.0, screen and camera recording used libx264 on the CPU. v0.5.0
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.5.0
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.5.0.


GPU DETECTION FIX — v0.5.0
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.5.0 fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.5.0
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.5.0
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.5.0
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.5.0
--------------------------------
