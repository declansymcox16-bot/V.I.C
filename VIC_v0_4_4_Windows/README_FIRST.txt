...
WINDOWS v0.4.4 — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SHARED SPEAKER LOOPBACK — v0.4.4
--------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.4.4
------------------------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.4.4
------------------------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.4.4 folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.4.4
--------------------------------
...
MASS RECORDING TRANSFERS — v0.4.4
---------------------------------
...
unless the source and destination computers are both running VIC v0.4.4. This
...
v0.4.4 Dashboard. Updating all PCs to v0.4.4 is still recommended.
