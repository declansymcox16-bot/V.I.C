...
app = Flask(__name__)
app.secret_key = "vic-v0.4.4-local-dashboard"

DASHBOARD_VERSION = "0.4.4"
...
def transfer_worker_ready(
    ...
    if version_tuple(current) < MIN_TRANSFER_WORKER_VERSION:
        ...
        return False, (
            ...
            "START_WORKER.bat from the v0.4.4 folder."
        )
    return True, ""
...
<header><h1>VIC — Video Ingest Cluster v0.4.4</h1><nav><a href='/'>Dashboard</a><a href='/add'>+ Add source</a><a href='/mass-capture'>Capture Everything</a><a href='/workers'>Workers</a><a href='/live'>Live</a><a href='/live/all'>Live All</a><a href='/recordings'>Recordings</a><a href='/jobs'>Jobs</a><a href='/help'>Help</a></nav></header><main>
...
def retry_transfer(transfer_id: str):
    ...
    update_transfer(
        ...
        state="queued_upload",
        message=(
            "Retry queued. Waiting for the v0.4.4 source worker "
