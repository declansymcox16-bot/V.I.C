...
WINDOWS v0.6.7 EXPERIMENTAL LIVE ALL REFLOW — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
------------------------------------
...
FASTER AUDIO METERS — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
----------------------------
...
LIVE ALL CONTROL ROOM — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
------------------------------
...
CLEAR / DELETE CONTROLS — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
--------------------------------
...
EDIT SOURCES — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
------------------------------------------
...
EDIT PAGE REPAIR — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.6.7 EXPERIMENTAL LIVE ALL REFLOW folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
--------------------------------
...
MASS RECORDING TRANSFERS — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
------------------------------
...
unless the source and destination computers are both running VIC v0.6.7 EXPERIMENTAL LIVE ALL REFLOW. This
...
TRACEBACK FIXES — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
------------------------
...
v0.6.7 EXPERIMENTAL LIVE ALL REFLOW Dashboard. Updating all PCs to v0.6.7 EXPERIMENTAL LIVE ALL REFLOW is still recommended.


PREVIEW MODE — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
---------------------
...
Before v0.6.7 EXPERIMENTAL LIVE ALL REFLOW, screen and camera recording used libx264 on the CPU. v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.6.7 EXPERIMENTAL LIVE ALL REFLOW.


GPU DETECTION FIX — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.6.7 EXPERIMENTAL LIVE ALL REFLOW fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.6.7 EXPERIMENTAL LIVE ALL REFLOW
------------------------------------------
