...
WINDOWS v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
------------------------------------
...
FASTER AUDIO METERS — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
----------------------------
...
LIVE ALL CONTROL ROOM — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
------------------------------
...
CLEAR / DELETE CONTROLS — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
--------------------------------
...
EDIT SOURCES — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
------------------------------------------
...
EDIT PAGE REPAIR — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
--------------------------------
...
MASS RECORDING TRANSFERS — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
------------------------------
...
unless the source and destination computers are both running VIC v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR. This
...
TRACEBACK FIXES — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
------------------------
...
v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR Dashboard. Updating all PCs to v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR is still recommended.


PREVIEW MODE — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
---------------------
...
Before v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR, screen and camera recording used libx264 on the CPU. v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR.


GPU DETECTION FIX — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.8.1 EXPERIMENTAL WORKER SETUP REPAIR
------------------------------------------
