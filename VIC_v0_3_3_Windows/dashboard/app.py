...
app = Flask(__name__)
app.secret_key = "vic-v0.3.3-local-dashboard"
...
<header><h1>VIC — Video Ingest Cluster v0.3.3</h1><nav><a href='/'>Dashboard</a><a href='/add'>+ Add source</a><a href='/mass-capture'>Capture Everything</a><a href='/workers'>Workers</a><a href='/live'>Live</a><a href='/recordings'>Recordings</a><a href='/jobs'>Jobs</a><a href='/help'>Help</a></nav></header><main>
...
<p class='muted small'>Microphone/input choices are added into the screen MKV. Speaker/headphone loopback choices create a matching companion WAV file beside the screen recording, with a live volume meter.</p>
