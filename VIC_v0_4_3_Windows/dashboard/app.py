...
app = Flask(__name__)
app.secret_key = "vic-v0.4.3-local-dashboard"
...
def transfer_worker_ready(
    ...
    if version_tuple(current) < MIN_TRANSFER_WORKER_VERSION:
        ...
        return False, (
            ...
            "START_WORKER.bat from the v0.4.3 folder."
        )
    return True, ""
...
def refresh_waiting_transfer_messages() -> None:
    ...
    for item in data:
        ...
        if not ready:
            ...
            message = (
                "The source worker is online with VIC v0.4.3, but has not "
...
<header><h1>VIC — Video Ingest Cluster v0.4.3</h1><nav><a href='/'>Dashboard</a><a href='/add'>+ Add source</a><a href='/mass-capture'>Capture Everything</a><a href='/workers'>Workers</a><a href='/live'>Live</a><a href='/live/all'>Live All</a><a href='/recordings'>Recordings</a><a href='/jobs'>Jobs</a><a href='/help'>Help</a></nav></header><main>
...
def retry_transfer(transfer_id: str):
    ...
    update_transfer(
        ...
        state="queued_upload",
        message=(
            "Retry queued. Waiting for the v0.4.3 source worker "
