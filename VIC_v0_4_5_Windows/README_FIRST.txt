...
WINDOWS v0.4.5 — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SHARED SPEAKER LOOPBACK — v0.4.5
--------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.4.5
------------------------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.4.5
------------------------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.4.5 folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.4.5
--------------------------------
...
MASS RECORDING TRANSFERS — v0.4.5
---------------------------------
...
unless the source and destination computers are both running VIC v0.4.5. This
...
v0.4.5 Dashboard. Updating all PCs to v0.4.5 is still recommended.
...
Before v0.4.5, screen and camera recording used libx264 on the CPU. v0.4.5
