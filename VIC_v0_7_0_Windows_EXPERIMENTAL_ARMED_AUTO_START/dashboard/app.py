...
app = Flask(__name__)
app.secret_key = "vic-v0.7.0 EXPERIMENTAL ARMED AUTO START-local-dashboard"
...
def transfer_worker_ready(
    ...
    if version_tuple(current) < MIN_TRANSFER_WORKER_VERSION:
        ...
        return False, (
            ...
            "START_WORKER.bat from the v0.7.0 EXPERIMENTAL ARMED AUTO START folder."
        )
    return True, ""
...
liveAllLoop();
    ...
    return render_template_string(page("Live All", body, script), jobs=data, job_ids=[item["id"] for item in data], stamp=time.time(), preview_types=PREVIEW_SOURCE_TYPES, auto_start_types=AUTO_START_SOURCE_TYPES, audio_refresh_seconds=live_cfg["audio_meter_refresh_seconds"], preview_refresh_seconds=live_cfg["preview_refresh_seconds"], audio_smoothing=live_cfg["audio_meter_smoothing"], audio_motion=live_cfg["audio_meter_motion"])
...
if __name__ == "__main__":
    ...
    print("VIC dashboard v0.7.0 EXPERIMENTAL ARMED AUTO START")
