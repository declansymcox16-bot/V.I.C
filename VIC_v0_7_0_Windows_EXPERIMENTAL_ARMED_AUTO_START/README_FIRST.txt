...
WINDOWS v0.7.0 EXPERIMENTAL ARMED AUTO START — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.7.0 EXPERIMENTAL ARMED AUTO START
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.7.0 EXPERIMENTAL ARMED AUTO START
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.7.0 EXPERIMENTAL ARMED AUTO START
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.7.0 EXPERIMENTAL ARMED AUTO START
------------------------------------
...
FASTER AUDIO METERS — v0.7.0 EXPERIMENTAL ARMED AUTO START
----------------------------
...
LIVE ALL CONTROL ROOM — v0.7.0 EXPERIMENTAL ARMED AUTO START
------------------------------
...
CLEAR / DELETE CONTROLS — v0.7.0 EXPERIMENTAL ARMED AUTO START
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.7.0 EXPERIMENTAL ARMED AUTO START
--------------------------------
...
EDIT SOURCES — v0.7.0 EXPERIMENTAL ARMED AUTO START
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.7.0 EXPERIMENTAL ARMED AUTO START
------------------------------------------
...
EDIT PAGE REPAIR — v0.7.0 EXPERIMENTAL ARMED AUTO START
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.7.0 EXPERIMENTAL ARMED AUTO START folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.7.0 EXPERIMENTAL ARMED AUTO START
--------------------------------
...
MASS RECORDING TRANSFERS — v0.7.0 EXPERIMENTAL ARMED AUTO START
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.7.0 EXPERIMENTAL ARMED AUTO START
------------------------------
...
unless the source and destination computers are both running VIC v0.7.0 EXPERIMENTAL ARMED AUTO START. This
...
TRACEBACK FIXES — v0.7.0 EXPERIMENTAL ARMED AUTO START
------------------------
...
v0.7.0 EXPERIMENTAL ARMED AUTO START Dashboard. Updating all PCs to v0.7.0 EXPERIMENTAL ARMED AUTO START is still recommended.


PREVIEW MODE — v0.7.0 EXPERIMENTAL ARMED AUTO START
---------------------
...
Before v0.7.0 EXPERIMENTAL ARMED AUTO START, screen and camera recording used libx264 on the CPU. v0.7.0 EXPERIMENTAL ARMED AUTO START
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.7.0 EXPERIMENTAL ARMED AUTO START
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.7.0 EXPERIMENTAL ARMED AUTO START.


GPU DETECTION FIX — v0.7.0 EXPERIMENTAL ARMED AUTO START
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.7.0 EXPERIMENTAL ARMED AUTO START fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.7.0 EXPERIMENTAL ARMED AUTO START
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.7.0 EXPERIMENTAL ARMED AUTO START
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.7.0 EXPERIMENTAL ARMED AUTO START
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.7.0 EXPERIMENTAL ARMED AUTO START
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.7.0 EXPERIMENTAL ARMED AUTO START
------------------------------------------
