@echo off
setlocal
title VIC v0.3.1 Installer
cd /d "%~dp0"
echo ==========================================
echo VIC v0.3.1 Dependency Installer
echo ==========================================
echo.
...
if errorlevel 1 goto :failed
python -c "import flask, psutil, yt_dlp; print('VIC packages installed correctly')"
if errorlevel 1 goto :failed
echo.
echo SUCCESS: Flask, psutil and yt-dlp are installed.
echo You can now run START_VIC.bat.
pause
exit /b 0
:failed
echo.
