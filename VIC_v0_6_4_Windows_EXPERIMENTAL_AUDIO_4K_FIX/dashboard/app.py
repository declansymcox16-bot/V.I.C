...
app = Flask(__name__)
app.secret_key = "vic-v0.6.4 EXPERIMENTAL AUDIO + 4K FIX-local-dashboard"

DASHBOARD_VERSION = "0.6.4"
...
def transfer_worker_ready(
    ...
    if version_tuple(current) < MIN_TRANSFER_WORKER_VERSION:
        ...
        return False, (
            ...
            "START_WORKER.bat from the v0.6.4 EXPERIMENTAL AUDIO + 4K FIX folder."
        )
    return True, ""
...
if __name__ == "__main__":
    ...
    print("VIC dashboard v0.6.4 EXPERIMENTAL AUDIO + 4K FIX")
