...
WINDOWS v0.6.4 EXPERIMENTAL AUDIO + 4K FIX — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
------------------------------------
...
FASTER AUDIO METERS — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
----------------------------
...
LIVE ALL CONTROL ROOM — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
------------------------------
...
CLEAR / DELETE CONTROLS — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
--------------------------------
...
EDIT SOURCES — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
------------------------------------------
...
EDIT PAGE REPAIR — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.6.4 EXPERIMENTAL AUDIO + 4K FIX folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
--------------------------------
...
MASS RECORDING TRANSFERS — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
------------------------------
...
unless the source and destination computers are both running VIC v0.6.4 EXPERIMENTAL AUDIO + 4K FIX. This
...
TRACEBACK FIXES — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
------------------------
...
v0.6.4 EXPERIMENTAL AUDIO + 4K FIX Dashboard. Updating all PCs to v0.6.4 EXPERIMENTAL AUDIO + 4K FIX is still recommended.


PREVIEW MODE — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
---------------------
...
Before v0.6.4 EXPERIMENTAL AUDIO + 4K FIX, screen and camera recording used libx264 on the CPU. v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.6.4 EXPERIMENTAL AUDIO + 4K FIX.


GPU DETECTION FIX — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.6.4 EXPERIMENTAL AUDIO + 4K FIX fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.6.4 EXPERIMENTAL AUDIO + 4K FIX
------------------------------------------
