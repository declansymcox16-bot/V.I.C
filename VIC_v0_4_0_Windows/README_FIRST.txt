...
WINDOWS v0.4.0 — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SHARED SPEAKER LOOPBACK — v0.4.0
--------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.4.0
------------------------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.4.0
------------------------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.4.0 folder and run START_WORKER.bat.
The worker now:
