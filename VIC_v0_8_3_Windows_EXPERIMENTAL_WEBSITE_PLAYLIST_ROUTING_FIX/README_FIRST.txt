...
WINDOWS v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
------------------------------------
...
FASTER AUDIO METERS — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
----------------------------
...
LIVE ALL CONTROL ROOM — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
------------------------------
...
CLEAR / DELETE CONTROLS — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
--------------------------------
...
EDIT SOURCES — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
------------------------------------------
...
EDIT PAGE REPAIR — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
--------------------------------
...
MASS RECORDING TRANSFERS — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
------------------------------
...
unless the source and destination computers are both running VIC v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX. This
...
TRACEBACK FIXES — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
------------------------
...
v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX Dashboard. Updating all PCs to v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX is still recommended.


PREVIEW MODE — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
---------------------
...
Before v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX, screen and camera recording used libx264 on the CPU. v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX.


GPU DETECTION FIX — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.8.3 EXPERIMENTAL WEBSITE + PLAYLIST ROUTING FIX
------------------------------------------
