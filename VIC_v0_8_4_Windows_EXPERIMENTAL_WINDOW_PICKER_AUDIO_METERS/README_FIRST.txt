...
WINDOWS v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS — BULK CONTROLS + PHYSICAL DISPLAY MODES
================================================
...
SCREEN AUDIO DROPDOWN — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
------------------------------
...
SHARED SPEAKER LOOPBACK — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
--------------------------------
...
BULK DASHBOARD BUTTONS — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
-------------------------------
...
PHYSICAL MONITOR RESOLUTION — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
------------------------------------
...
FASTER AUDIO METERS — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
----------------------------
...
LIVE ALL CONTROL ROOM — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
------------------------------
...
CLEAR / DELETE CONTROLS — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
--------------------------------
Dashboard:
• Clear old history
• Delete All Sources
...
YOUTUBE / WEBSITE MODES — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
--------------------------------
...
EDIT SOURCES — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
---------------------
...
OPTIONAL LOGIN PER WEBSITE SOURCE — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
------------------------------------------
...
EDIT PAGE REPAIR — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
-------------------------
...
--------------------------------------
On a second PC, copy the whole VIC v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS folder and run START_WORKER.bat.
The worker now:
...
VERIFIED FILE TRANSFERS — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
--------------------------------
...
MASS RECORDING TRANSFERS — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
---------------------------------
...
TRANSFER QUEUE REPAIR — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
------------------------------
...
unless the source and destination computers are both running VIC v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS. This
...
TRACEBACK FIXES — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
------------------------
...
v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS Dashboard. Updating all PCs to v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS is still recommended.


PREVIEW MODE — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
---------------------
...
Before v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS, screen and camera recording used libx264 on the CPU. v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
...
GPU ENCODER AUTO-DETECTION REPAIR — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
------------------------------------------
...
working GPU encoder after the worker is restarted with v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS.


GPU DETECTION FIX — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
--------------------------
v0.4.6 double-escaped the regular expressions used to read `ffmpeg -encoders`, falsely reporting NVENC, AMF and QSV as missing. v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS fixes the parser and always runs the real 30-frame encoder test. The runtime result is authoritative.


PER-WORKER COMPATIBLE FFMPEG — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
-------------------------------------
...
MULTIPLE SCREEN AUDIO DEVICES — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
--------------------------------------
...
LIVE FILE-TRANSFER PROGRESS — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
------------------------------------
...
FAST PARALLEL TRANSFERS — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
--------------------------------
...
RETRY ALL AND MORE PARALLEL SLOTS — v0.8.4 EXPERIMENTAL WINDOW PICKER + AUDIO METERS
------------------------------------------
